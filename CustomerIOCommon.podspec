Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => 'https://github.com/rcruzmu/customerio-ios.git', :tag => spec.version.to_s }
  ...
  spec.module_name = "CioCommon" # the `import X` name when using SDK in Swift files
end